    ...
    <div className="card-glass overflow-hidden h-[320px] sm:h-[420px] flex flex-col">
      <div className="p-4 sm:p-6 border-b border-white/[0.06] bg-white/[0.015] flex-shrink-0">
        ...
        <select
          ...
          className="w-full px-3 py-2 border border-white/[0.08] bg-white/[0.04] text-foreground rounded-md focus:outline-none focus:ring-2 focus:ring-accent/40 text-sm"
        >
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-6">
        {exercises.length === 0 ? (
          ...
          <div className="space-y-2">
            ...
            <div
              key={index}
                className="flex items-center justify-between p-3 bg-white/[0.025] rounded-lg border border-white/[0.05] shadow-[0_1px_2px_rgba(0,0,0,0.1)] hover:bg-white/[0.04] transition-colors"
            >
