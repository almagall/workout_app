...
CREATE TABLE workout_sessions (
  ...
  overall_performance_rating NUMERIC(3, 1) CHECK (overall_performance_rating >= 1 AND overall_performance_rating <= 10),
  overall_feedback TEXT,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  UNIQUE(user_id, template_day_id, workout_date)
);
